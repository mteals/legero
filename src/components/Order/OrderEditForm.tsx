    ...
    <dialog ref={dialogRef} className="modal" onClose={handleDialogClose}>
      <div className="modal-box w-11/12 max-w-5xl">
        ...
        <fieldset className="fieldset rounded-box">
          <legend className="fieldset-legend text-2xl font-bold mb-2">修改订单</legend>
          ...
          <div className="flex flex-row">
            ...
            <label className="fieldset-label text-xl">
              {item.size === '自定义' && (
                <input type="text text-xl" className="input" value={item.customSizePrice} onChange={handleCustomSizePriceChange} disabled={!item.includeNoodles} />
              )}
            </label>
          </div>
