          ...
          <fieldset className="fieldset rounded-box">
            ...
            <div className="flex flex-row">
              ...
              <div className="flex flex-row gap-3">
                <button
                  className="btn btn-square text-xl transition-all duration-700"
                ...
                <button
                  className={
                    item.noodleType === "河粉"
                      ? "btn text-xl btn-primary transition-all duration-700"
                      : "btn text-xl transition-all duration-700"
                  }
                  hidden={
            ...
            <div className="flex flex-row">
              ...
              <div className="flex flex-row gap-3 mr-2 my-2">
                ...
                <button
                  className={
                    item.size === "小"
                      ? "btn text-xl btn-primary transition-all duration-200"
                      : "btn text-xl transition-all duration-200"
                  }
